       ...
       <table class="table table-bordered" id="datatable" style="background-color: white; ">
          ...
          @foreach($view as $view)
                  <tr class="rem1">
                        ...
                        <td class="invert" style="font-family: sans-serif;" id="amount{{$view->id}}">{{$view->w_price}}</td>
                        ...
                        <td class="invert" style=" font-family: sans-serif;" id="subtotal{{$view->id}}">{{($view->w_price*$view->quantity)-$view->cart_discount_in_tk-((($view->w_price*$view->quantity)*$view->cart_discount_in_percentage)/100)
                        }}</td>
