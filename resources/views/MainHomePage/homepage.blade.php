...
<div class="flexslider">
   	<div class="flex-viewport" style="overflow: hidden; position: relative;">
       	...
       	@foreach($posts as $posts)
    		<li class="clone" style="width:100%; float: left; display: block;">
    	    	<img src="{{$posts->image}}" style="max-height: 455px; width: 120%;" alt=""/>
...
<div class="section group" style="background-color:green;">
	...
	<div class="col_1_of_5 span_1_of_5" style="background-color: blue;">
		...
		<div class="grid-imgs">
			<div style="width: 100%">
				<img style="width: 40%;  padding-top:10px;float: left;" src="{{$catagory->c_image}}" alt="">
		 <a style="width: 60%;float: right;" href="{{URL('subcatagorylist/'.$catagory->id)}}"><p style="text-align: center; font-family: Arial;font-size: 20px;color: white;">{{$catagory->c_name}}</p></a> 
