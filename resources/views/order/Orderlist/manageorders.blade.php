						...
						<table class="table table-bordered" id="datatable" style="background-color: powderblue;">
						 ...
						 <th class="col-sm-4" style="text-align: center;">Action</th>  
						   ...
						   <th scope="row" style="text-align: center;">{{$allorders->order_id}}</th> 
						    ...
						    <td style="text-align: center;">{{$allorders->del_status}}</td>
						    <td style="text-align: center;">
                         		 <a href="{{URL('allorder/edit/'.$allorders->order_id)}}" class="btn btn-success">
                           		 ...
                           		 <a href="{{URL('allorder/delivered/'.$allorders->order_id)}}" class="btn btn-success">
                            		<span style="width: 50px; height: 10px; border-radius: 60%; color: black; font-size: 12px;" class="glyphicon glyphicon-check">Deliver</span>  


 									<a href="{{URL('allorder/pending/'.$allorders->order_id)}}" class="btn btn-danger">
                            		<span style="width: 50px; height: 10px; border-radius: 60%; color: black; font-size: 12px;" class="glyphicon glyphicon-backward">Pen</span> 
                          </td>
