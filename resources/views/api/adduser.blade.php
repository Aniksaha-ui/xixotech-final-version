...
<div class="form-three widget-shadow" style=" background-color: #659DBD">
              ...
              <p style="color: black;text-align: center;font-family: Arial;">New User</p>
                 <form method="POST" action="{{url('https://xixotech.net/api/adduserbyapi')}}" class="form-horizontal" enctype="multipart/form-data">
                       {{csrf_field()}} 
                  <div class="form-group" style="margin-left: 200px;margin-left: 100px; padding-top: 30px; padding-bottom: 30px;">
                    ...
                    <div class="col-md-8">
                      ...
                      <br>
                             ...
                             <div class="form-group">
                    <label class="col-md-2 control-label">Password1</label>
                    <div class="col-md-8">
                      <div class="input-group">             
                        <span class="input-group-addon">
                          <i class="fa fa-circle-o"></i>
                        </span>
                        <input type="password1" style="color: black;" class="form-control1" placeholder="Enter Password" name="password1">
                      </div>
                      <br>
                   </div>
                    </div>
